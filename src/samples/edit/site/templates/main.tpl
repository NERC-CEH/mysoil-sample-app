<ul class="table-view core inputs no-top <%- obj.isSynchronising ? 'disabled' : '' %>">
  ...
  <li class="table-view-cell">
    <a href="#samples/<%- obj.id %>/edit/field-name" id="field-name-button"
      ...
      <span class="media-object pull-left icon icon-field-name"></span>
  ...
  <li class="table-view-cell">
    <a href="#samples/<%- obj.id %>/edit/field-size" id="field-size-button"
      ...
      <span class="media-object pull-left icon icon-field-size"></span>
  ...
  <li class="table-view-cell">
    <a href="#samples/<%- obj.id %>/edit/depth" id="depth-button"
      ...
      <span class="media-object pull-left icon icon-depth"></span>
  ...
  <li class="table-view-cell">
    <a href="#samples/<%- obj.id %>/edit/soil" id="soil-button"
      ...
      <span class="media-object pull-left icon icon-soil"></span>
  ...
  <li class="table-view-cell">
    <a href="#samples/<%- obj.id %>/edit/crop-present" id="crop-present-button"
      ...
      <span class="media-object pull-left icon icon-crop-present"></span>
  ...
  <li class="table-view-cell">
    <a href="#samples/<%- obj.id %>/edit/crop-future" id="crop-future-button"
      ...
      <span class="media-object pull-left icon icon-crop-future"></span>
  ...
  <li class="table-view-cell">
    <a href="#samples/<%- obj.id %>/edit/straw" id="straw-button"
      ...
      <span class="media-object pull-left icon icon-straw"></span>
  ...
  <li class="table-view-cell">
    <a href="#samples/<%- obj.id %>/edit/manure" id="manure-button"
      ...
      <span class="media-object pull-left icon icon-manure"></span>
